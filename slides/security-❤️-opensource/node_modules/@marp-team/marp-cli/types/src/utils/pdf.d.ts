...
declare type PDFOutlineTo = number | [pageIndex: number, xPercentage: number, yPercentage: number];
...
export declare type PDFOutline = PDFOutlineItem | PDFOutlineItemWithChildren;
